...
class BinarySearchTree:
    ...
    def __sorted_list_to_bst(self, nums, left, right):
        ...
        current_node=Node(nums[mid_index])
        current_node.left=self.__sorted_list_to_bst(nums,left,mid_index-1)
        current_node.right=self.__sorted_list_to_bst(nums,mid_index+1,right)
        return current_node
